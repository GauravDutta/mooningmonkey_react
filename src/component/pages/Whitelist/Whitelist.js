            ...
            <div className='container'>
                <div className='row'>
                    <div className='col-md-12 text-center '>
                        <h2 className='heading-big'>ACCESS YOUR <br/>WHITELIST SPOT</h2>
                ...
                <div className='row'>
					<div className='col-md-12 '> 
									<div className='col-md-6 offset-3 box top-30 whitelist-cal'>
										...
										<p className='white-text'>Press the connect wallet button to claim and pay for your Whitelist spot.</p>
										<div className='row top-30'>
												<div className='col-4'><img src={require('../Whitelist/img/monkey-2.png')} className="img-responsive " alt='stage-1'/></div>
											<div className='col-8 text-right'>
												<p className='top-20'>Mooning Monkey Price</p>
												<h4> <span>0.15</span> ETH</h4>
												<p><span>2’500 remaining</span></p>
											</div>
										</div>
										<div className='row total-sec'>
											<h3>1 <span>0.15 ETH max </span></h3>

										</div>
										<div className='row top-30 total-sec2'>
											<h3>Total <span><span className='pink'>0.15</span> ETH </span></h3>

										</div>
										<div className='row top-20'>
										<a className='btn btn-dark' href='#'>CONNECT   WALLET</a>
